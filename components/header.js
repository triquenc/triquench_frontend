                    ...
                    <div className="products-dropdown" style={{
                      ...
                      <div className="products-grid" style={{
                        ...
                        {products.map((product, index) => (
                          ...
                          >
                            <a href={product.href} style={{ textDecoration: "none", color: "#fff", display: "block" }}>
                              <ul style={{ listStyle: 'none', padding: 0, margin: 0, display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                                <li style={{ width: "60px", height: "60px", display: "flex", alignItems: "center", justifyContent: "center" }}>
                                  <Image src={product.url} width={100} height={100} alt={product.label} style={{ borderRadius: "8px", objectFit: "contain" }} />
                                </li>
                                <li style={{ marginTop: "5px" }}>
                                  <span style={{ display: "block", fontWeight: "bold", fontSize: "0.9em" }}>{product.label}</span>
                                </li>
                              </ul>
                            </a>
                          </div>
