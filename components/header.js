        ...
        <div className="container">
            <div className="header-wrapper">
                <div className="logo-wrapper">
                    <a href="/">
                        <Image src="/images/site-logo.svg" width={86} height={75} alt="Triqunch Logo"/>
                    </a>
                </div>
                ...
                <div className="contact-wrapper d-flex align-center justify-end">
                    <a href="/contact" className="border-btn">CONTACT US <Image src="/images/call-ic.svg" width={25} height={18} alt="call-ic" /></a>
